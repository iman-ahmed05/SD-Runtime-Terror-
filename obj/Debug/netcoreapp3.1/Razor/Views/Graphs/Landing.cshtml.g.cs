#pragma checksum "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6e202167cce89ccac1141973963a95f7a06cb0f1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6e202167cce89ccac1141973963a95f7a06cb0f1", @"/Views/Graphs/Landing.cshtml")]
    ...
    public class Views_Graphs_Landing : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
...
#nullable disable
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e202167cce89ccac1141973963a95f7a06cb0f13661", async() => {
                WriteLiteral(@"
    ...
    <script type=""text/javascript"">
        ...
        function drawMale() {
            var data = google.visualization.arrayToDataTable([
                ...
                ['2014', 274, 86, 174, 26, ''],
     ");
                WriteLiteral(@"           ['2015', 230, 61, 203, 27, ''],
                ['2016', 358, 70, 244, 48, ''],
                ['2017', 293, 34, 276, 113, ''],
            ...
            var materialOptions = {
                chart: {
                    title: 'Progression of outcome for Males',
                },
                bars: 'vertical',
            };
        ...
        function drawFemale() {
            var data = google.visualization.arrayToDataTable([
                ...
                ['2012', 173, 38, 176, 30, ''],
       ");
                WriteLiteral(@"         ['2013', 212, 35, 61, 223, ''],
                ['2014', 196, 71, 56, 240, ''],
                ['2015', 152, 45, 53, 240, ''],
                ['2016', 206, 51, 71, 310, ''],
                ['2017', 200, 28, 79, 313, ''],
            ...
            var materialOptions = {
                chart: {
                    title: 'Progression of outcome for Females',
                },
                bars: 'vertical',
            };
        ...
        function drawReg() {
            ...
            chart.draw(data, google.charts.Bar.convertOptions(options));
                ...
                JSONgroup2008 = '");
#nullable restore
#line 135 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                            Write(Html.Raw(Json.Serialize(ViewBag.year08)));
...
#nullable disable
        ...
        JSONgroup2009 = '");
#nullable restore
#line 146 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                    Write(Html.Raw(Json.Serialize(ViewBag.year09)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2009), function (index, val) {
          ...
          JSONgroup2010 = '");
#nullable restore
#line 157 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                      Write(Html.Raw(Json.Serialize(ViewBag.year10)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2010), function (index, val) {
          ...
          JSONgroup2011 = '");
#nullable restore
#line 168 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                      Write(Html.Raw(Json.Serialize(ViewBag.year11)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2011), function (index, val) {
            ...
            JSONgroup2012 = '");
#nullable restore
#line 179 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year12)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2012), function (index, val) {
            ...
            JSONgroup2013 = '");
#nullable restore
#line 190 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year13)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2013), function (index, val) {
            ...
            JSONgroup2014 = '");
#nullable restore
#line 201 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year14)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2014), function (index, val) {
           ...
           out14.push(arrgroup2014);
            ...
            JSONgroup2015 = '");
#nullable restore
#line 212 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year15)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2015), function (index, val) {
            ...
            JSONgroup2016 = '");
#nullable restore
#line 223 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year16)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2016), function (index, val) {
            ...
            JSONgroup2017 = '");
#nullable restore
#line 234 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year17)));
...
#nullable disable
        ...
        $.each(JSON.parse(JSONgroup2017), function (index, val) {
            ...
            JSONgroup2018 = '");
#nullable restore
#line 245 "C:\Users\craig\Desktop\Computer Science\COMS3009A Software Design 2020\SD Project\SD-Runtime-Terror-\Views\Graphs\Landing.cshtml"
                        Write(Html.Raw(Json.Serialize(ViewBag.year18)));
...
#nullable disable
        ...
        function drawgroup2010() {
            ...
            var chart = new google.visualization.PieChart(document.getElementById('piechart201");
                WriteLiteral(@"0'));
            chart.draw(data, options);
        }
        ...
        function drawgroup2013() {
            ...
            var char");
                WriteLiteral(@"t = new google.visualization.PieChart(document.getElementById('piechart2013'));
            chart.draw(data, options);
        }
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e202167cce89ccac1141973963a95f7a06cb0f122183", async() => {
                WriteLiteral(@"
    <h4>General Queries For Research</h4>
    <hr class=""my-4"" />
    <div>
    ...
    <div  id=""barchart_reg"" style=""width: 900px; height: 500px;""></div>
    <hr class=""my-4"" />

    <h5>Progression of Outcomes Per Year</h5><br />
    <table class=""columns"">
        <tr>
            <td><div id=""piechart2008"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
            <td><div id=""piechart2009"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
        </tr>
    </table>
    <table class=""columns"">
        <tr>
            <td><div id=""piechart2010"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div");
                WriteLiteral(@"></td>
            <td><div id=""piechart2011"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
        </tr>
    </table>
    <table class=""columns"">
        <tr>
            <td><div id=""piechart2012"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
            <td><div id=""piechart2013"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
        </tr>
    </table>
    <table class=""columns"">
        <tr>
            <td><div id=""piechart2014"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
            <td><div id=""piechart2015"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
        </tr>
    </table>
    <table class=""columns"">
        <tr>
            <td><div id=""piechart2016"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
            <td><div id=""piechart2017"" style=""width: 500px; height: 300px;border: 1px solid #ccc""></div></td>
        </tr>
    </ta");
                WriteLiteral(@"ble>
    <div id=""piechart2018"" style=""width: 1000px; height: 300px;border: 1px solid #ccc""></div>
    <hr class=""my-4"" />

    <h5>Progression of Outcomes for Males</h5><br />
    <div id=""barMale"" style=""width: 1000px; height: 500px;border: 1px solid #ccc""></div>
    <hr class=""my-4"" />

    <h5>Progression of Outcomes for Females</h5><br />
    <div id=""barFemale"" style=""width: 1000px; height: 500px;border: 1px solid #ccc""></div>
    <hr class=""my-4"" />

    <h5>Starting Age of Students</h5><br />
