...
namespace BID_E.Testing
{
    public class TestGen
    {
        ...
        LookupProv lookprov = new LookupProv
        {
            reg_End = "ijfio",
            count = 5
        };
        [Fact]
        public void LookupProvTest()
        {
            string expected = "ijfio";
            Assert.Equal(expected, lookprov.reg_End);

        }
        [Fact]
        public void LookupProvCountTest()
        {
            int expected = 5;
            Assert.Equal(expected, lookprov.count);
